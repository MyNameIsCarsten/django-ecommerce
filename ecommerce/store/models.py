...
class Order(models.Model):
    ...
    def shipping(self):
        shipping = False
        orderItems = self.orderitem_set.all() #queryset of all orderitems in this order

        for i in orderItems:
            if i.product.digital == False: # if single orderitem has digital == False (physical item)
                shipping = True
        return shipping
